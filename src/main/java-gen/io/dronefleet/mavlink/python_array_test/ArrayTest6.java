...
public final class ArrayTest6 {
    ...
    private ArrayTest6(int v1, int v2, long v3, int[] arU32, int[] arI32, short[] arU16,
            short[] arI16, byte[] arU8, byte[] arI8, String arC, List<Double> arD,
            List<Float> arF) {
        this.v1 = v1;
        this.v2 = v2;
        this.v3 = v3;
    ...
    public static Builder builder(ArrayTest6 msg) {
        return builder()
                .v1(msg.v1)
                .v2(msg.v2)
                .v3(msg.v3)
