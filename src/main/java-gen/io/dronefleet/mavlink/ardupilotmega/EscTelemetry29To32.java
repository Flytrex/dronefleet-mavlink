...
@MavlinkMessageInfo(
        id = 11044,
        crc = 189,
        description = "ESC Telemetry Data for ESCs 29 to 32, matching data sent by BLHeli ESCs."
)
public final class EscTelemetry29To32 {
    ...
    private EscTelemetry29To32(byte[] temperature, short[] voltage, short[] current,
    ...
    public static Builder builder(EscTelemetry29To32 msg) {
        return builder()
    ...
    public boolean equals(Object o) {
        ...
        EscTelemetry29To32 other = (EscTelemetry29To32)o;
    ...
    public String toString() {
        return "EscTelemetry29To32{temperature=" + temperature
                 + ", voltage=" + voltage
                 + ", current=" + current
    ...
    public static final class Builder {
        ...
        public final EscTelemetry29To32 build() {
            return new EscTelemetry29To32(temperature, voltage, current, totalcurrent, rpm, count);
        }
    }
}
