...
@MavlinkMessageInfo(
        id = 11040,
        crc = 132,
        description = "ESC Telemetry Data for ESCs 13 to 16, matching data sent by BLHeli ESCs."
)
public final class EscTelemetry13To16 {
    ...
    private EscTelemetry13To16(byte[] temperature, short[] voltage, short[] current,
    ...
    public static Builder builder(EscTelemetry13To16 msg) {
        return builder()
    ...
    public boolean equals(Object o) {
        ...
        EscTelemetry13To16 other = (EscTelemetry13To16)o;
    ...
    public String toString() {
        return "EscTelemetry13To16{temperature=" + temperature
                 + ", voltage=" + voltage
                 + ", current=" + current
    ...
    public static final class Builder {
        ...
        public final EscTelemetry13To16 build() {
            return new EscTelemetry13To16(temperature, voltage, current, totalcurrent, rpm, count);
        }
    }
}
