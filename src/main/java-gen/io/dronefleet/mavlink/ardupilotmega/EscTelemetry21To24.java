...
@MavlinkMessageInfo(
        id = 11042,
        crc = 201,
        description = "ESC Telemetry Data for ESCs 21 to 24, matching data sent by BLHeli ESCs."
)
public final class EscTelemetry21To24 {
    ...
    private EscTelemetry21To24(byte[] temperature, short[] voltage, short[] current,
    ...
    public static Builder builder(EscTelemetry21To24 msg) {
        return builder()
    ...
    public boolean equals(Object o) {
        ...
        EscTelemetry21To24 other = (EscTelemetry21To24)o;
    ...
    public String toString() {
        return "EscTelemetry21To24{temperature=" + temperature
                 + ", voltage=" + voltage
                 + ", current=" + current
    ...
    public static final class Builder {
        ...
        public final EscTelemetry21To24 build() {
            return new EscTelemetry21To24(temperature, voltage, current, totalcurrent, rpm, count);
        }
    }
}
