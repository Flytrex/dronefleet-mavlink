...
public final class EscTelemetry25To28 {
    ...
    private EscTelemetry25To28(byte[] temperature, short[] voltage, short[] current,
    ...
    public static Builder builder(EscTelemetry25To28 msg) {
        return builder()
    ...
    public boolean equals(Object o) {
        ...
        EscTelemetry25To28 other = (EscTelemetry25To28)o;
    ...
    public String toString() {
        return "EscTelemetry25To28{temperature=" + temperature
                 + ", voltage=" + voltage
                 + ", current=" + current
    ...
    public static final class Builder {
        ...
        public final EscTelemetry25To28 build() {
            return new EscTelemetry25To28(temperature, voltage, current, totalcurrent, rpm, count);
        }
    }
}
