...
public final class McuStatus {
    ...
    public static Builder builder(McuStatus msg) {
        return builder()
                .id(msg.id)
                .mcuTemperature(msg.mcuTemperature)
                .mcuVoltage(msg.mcuVoltage)
                .mcuVoltageMin(msg.mcuVoltageMin)
                .mcuVoltageMax(msg.mcuVoltageMax);
    }
