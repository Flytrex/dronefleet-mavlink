...
@MavlinkMessageInfo(
        id = 11041,
        crc = 208,
        description = "ESC Telemetry Data for ESCs 17 to 20, matching data sent by BLHeli ESCs."
)
public final class EscTelemetry17To20 {
    ...
    private EscTelemetry17To20(byte[] temperature, short[] voltage, short[] current,
    ...
    public static Builder builder(EscTelemetry17To20 msg) {
        return builder()
    ...
    public boolean equals(Object o) {
        ...
        EscTelemetry17To20 other = (EscTelemetry17To20)o;
    ...
    public String toString() {
        return "EscTelemetry17To20{temperature=" + temperature
                 + ", voltage=" + voltage
                 + ", current=" + current
    ...
    public static final class Builder {
        ...
        public final EscTelemetry17To20 build() {
            return new EscTelemetry17To20(temperature, voltage, current, totalcurrent, rpm, count);
        }
    }
}
