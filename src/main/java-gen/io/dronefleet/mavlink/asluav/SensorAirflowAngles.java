...
public final class SensorAirflowAngles {
    ...
    public static Builder builder(SensorAirflowAngles msg) {
        return builder()
                .timestamp(msg.timestamp)
                .angleofattack(msg.angleofattack)
                .angleofattackValid(msg.angleofattackValid)
                .sideslip(msg.sideslip)
                .sideslipValid(msg.sideslipValid);
    }
