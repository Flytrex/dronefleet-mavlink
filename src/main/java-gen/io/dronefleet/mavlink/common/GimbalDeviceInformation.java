...
public final class GimbalDeviceInformation {
    ...
    public static Builder builder(GimbalDeviceInformation msg) {
        return builder()
                ...
                .uid(msg.uid)
                .capFlags(msg.capFlags)
                .customCapFlags(msg.customCapFlags)
                .rollMin(msg.rollMin)
                .rollMax(msg.rollMax)
                .pitchMin(msg.pitchMin)
                .pitchMax(msg.pitchMax)
                .yawMin(msg.yawMin)
                .yawMax(msg.yawMax);
    }
