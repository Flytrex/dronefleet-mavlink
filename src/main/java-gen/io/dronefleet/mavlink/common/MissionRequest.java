...
@Deprecated
public final class MissionRequest implements HasTransmissionId<MissionRequest> {
    ...
    public static Builder builder(MissionRequest msg) {
        return builder()
    ...
    @Override
    public MissionRequest withTransmissionId(int tid) {
    ...
    public static final class Builder {
        ...
        public final MissionRequest build() {
            return new MissionRequest(targetSystem, targetComponent, seq, missionType, tid);
        }
    }
}
