...
public final class OpenDroneIdMessagePack {
    ...
    public static Builder builder(OpenDroneIdMessagePack msg) {
        return builder()
                .targetSystem(msg.targetSystem)
                .targetComponent(msg.targetComponent)
                .idOrMac(msg.idOrMac)
                .singleMessageSize(msg.singleMessageSize)
                .msgPackSize(msg.msgPackSize)
     ...
     * messages are specificed to have this length. 
     */
    @MavlinkFieldInfo(
            position = 5,
            unitSize = 1,
