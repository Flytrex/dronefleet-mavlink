...
public final class SerialUdbExtraF2B {
    ...
    public static Builder builder(SerialUdbExtraF2B msg) {
        return builder()
                .sueTime(msg.sueTime)
                .suePwmInput1(msg.suePwmInput1)
                .suePwmInput2(msg.suePwmInput2)
                .suePwmInput3(msg.suePwmInput3)
                .suePwmInput4(msg.suePwmInput4)
                .suePwmInput5(msg.suePwmInput5)
                .suePwmInput6(msg.suePwmInput6)
                .suePwmInput7(msg.suePwmInput7)
                .suePwmInput8(msg.suePwmInput8)
                .suePwmInput9(msg.suePwmInput9)
                .suePwmInput10(msg.suePwmInput10)
                .suePwmInput11(msg.suePwmInput11)
                .suePwmInput12(msg.suePwmInput12)
                .suePwmOutput1(msg.suePwmOutput1)
                .suePwmOutput2(msg.suePwmOutput2)
                .suePwmOutput3(msg.suePwmOutput3)
                .suePwmOutput4(msg.suePwmOutput4)
                .suePwmOutput5(msg.suePwmOutput5)
                .suePwmOutput6(msg.suePwmOutput6)
                .suePwmOutput7(msg.suePwmOutput7)
                .suePwmOutput8(msg.suePwmOutput8)
                .suePwmOutput9(msg.suePwmOutput9)
                .suePwmOutput10(msg.suePwmOutput10)
                .suePwmOutput11(msg.suePwmOutput11)
                .suePwmOutput12(msg.suePwmOutput12)
                .sueImuLocationX(msg.sueImuLocationX)
                .sueImuLocationY(msg.sueImuLocationY)
                .sueImuLocationZ(msg.sueImuLocationZ)
                .sueLocationErrorEarthX(msg.sueLocationErrorEarthX)
                .sueLocationErrorEarthY(msg.sueLocationErrorEarthY)
                .sueLocationErrorEarthZ(msg.sueLocationErrorEarthZ)
                .sueFlags(msg.sueFlags)
                .sueOscFails(msg.sueOscFails)
                .sueImuVelocityX(msg.sueImuVelocityX)
                .sueImuVelocityY(msg.sueImuVelocityY)
                .sueImuVelocityZ(msg.sueImuVelocityZ)
                .sueWaypointGoalX(msg.sueWaypointGoalX)
                .sueWaypointGoalY(msg.sueWaypointGoalY)
                .sueWaypointGoalZ(msg.sueWaypointGoalZ)
                .sueAeroX(msg.sueAeroX)
                .sueAeroY(msg.sueAeroY)
                .sueAeroZ(msg.sueAeroZ)
                .sueBaromTemp(msg.sueBaromTemp)
                .sueBaromPress(msg.sueBaromPress)
                .sueBaromAlt(msg.sueBaromAlt)
                .sueBatVolt(msg.sueBatVolt)
                .sueBatAmp(msg.sueBatAmp)
                .sueBatAmpHours(msg.sueBatAmpHours)
                .sueDesiredHeight(msg.sueDesiredHeight)
                .sueMemoryStackFree(msg.sueMemoryStackFree);
    }
